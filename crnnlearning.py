...
class MelSpec(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 문자열 레이블을 정수 인덱스로 변환
        label_idx = self.genre_to_index[label]  # 예: 'rock' -> 9
        return mel_spec, torch.tensor(label_idx)  # 텐서 형태로 반환
...
class Model(nn.Module):
    def __init__(self, num_classes=10):
        ...
        # RNN Layer
        self.gru = nn.GRU(input_size=2048, hidden_size=64, num_layers=2, batch_first=True, bidirectional=True)
